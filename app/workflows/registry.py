...
NODE_REGISTRY = {
    ...
    "prepare_appointment_ingress": prepare_appointment_ingress,
    "read_appointment_lifecycle": read_appointment_lifecycle,
    "record_appointment_started": record_appointment_started,
    "run_appointment_intake": run_appointment_intake,
    "compute_appointment_decision": compute_appointment_decision,
    "record_appointment_decision": record_appointment_decision,
    "build_appointment_draft": build_appointment_draft,
    "persist_appointment_draft_ready": persist_appointment_draft_ready,
    "notify_appointment_draft_teams": notify_appointment_draft_teams,
    "send_appointment_draft_email": send_appointment_draft_email,
    "hydrate_appointment_send_context": hydrate_appointment_send_context,
    "apply_weekend_shifted_pickup": apply_weekend_shifted_pickup,
    "apply_turvo_delivery_placeholder": apply_turvo_delivery_placeholder,
    "finalize_appointment_awaiting_reply": finalize_appointment_awaiting_reply,
    "classify_appointment_customer_reply": classify_appointment_customer_reply,
