WORKFLOW_CONFIGS = {
    "pod_lifecycle": {
        ...
        "edges": [
            ...
            ["record_pod_extraction_activity", "capture_turvo_shipment_snapshot"],
        ...
        "routers": {
            ...
            "get_shipment": {
                ...
                "map": {
                    ...
                    # Pod reply workflow
                    "valid_shipment_status": "merge_and_upload_pod_attachments",
                    "manual_pod_stored": "upload_to_turvo",
                    "manual_pod_process": "merge_and_upload_pod_attachments",
    ...
    "ratecon": {
        ...
        "edges": [
            ...
            ["record_ratecon_received_activity", "cache_ratecon_page_count"],
            ["cache_ratecon_page_count", "record_ratecon_processed_activity"],
            [
                "record_ratecon_processed_activity",
                "enqueue_driver_assignment_on_ratecon_complete",
            ],
