WORKFLOW_CONFIGS = {
    ...
    "appointment_scheduling": {
        ...
        "edges": [
            ...
            ["persist_scheduling_draft_ready", "notify_appointment_scheduling_draft_teams"],
            ["notify_appointment_scheduling_draft_teams", "end"],
            ["apply_weekend_shifted_pickup", "send_appointment_scheduling_email"],
            ["send_appointment_scheduling_email", "apply_turvo_delivery_placeholder"],
