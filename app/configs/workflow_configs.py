WORKFLOW_CONFIGS = {
    "pod_lifecycle": {
        ...
        "edges": [
            ...
            ["update_shipment", "end"],
            ["send_email", "record_reminder_run"],
            ["record_reminder_run", "end"],
            ["record_and_schedule_pod_request", "end"],
        ],
        "routers": {
            "route_event": {
                "router": "event_type",
    ...
    "ratecon": {
        ...
        "edges": [
            ["resolve_load_to_shipment", "resolve_workflow_lifecycle"],
            ["resolve_workflow_lifecycle", "upload_ratecon_attachments"],
            ["upload_ratecon_attachments", "check_ratecon_workflow_lifecycle"],
