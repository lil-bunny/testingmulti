...
WORKFLOW_TEMPLATE_CONTRACTS = {
    ...
    "driver_assignment": WorkflowTemplateContract(
        ...
        version="1.0.0",
        description="Driver assignment workflow; triggered when ratecon completes, reminder_due, or driver details email received.",
        event_types=["ratecon_completed", "reminder_due", "driver_details_email_received"],
        required_state_keys=[
            "event_type",
            "load_id",
            "shipments_row_id",
