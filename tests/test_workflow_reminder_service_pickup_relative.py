...
def _driver_assignment_settings() -> dict:
    return {
        "driver_assignment": {
...
def _legacy_driver_assignment_settings() -> dict:
    return {
        "driver_assignment": {
            "reminders": {
...
def test_schedule_before_pickup_uses_eta(mock_task: MagicMock) -> None:
    ...
    data = {
        ...
        "tenant_settings": _driver_assignment_settings(),
    }
...
def test_schedule_before_pickup_legacy_offsets_normalized(mock_task: MagicMock) -> None:
    ...
    data = {
        ...
        "workflow_lifecycle_id": "wl-1",
        "pickup_appointment_at": pickup_at.isoformat(),
        "tenant_settings": _legacy_driver_assignment_settings(),
    }
